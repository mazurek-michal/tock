...
pub const RV_PLIC_PARAM_NUM_SRC: u32 = 188;
...
register_structs! {
    pub RvPlicRegisters {
        ...
        (0x02e4 => pub(crate) prio185: ReadWrite<u32, PRIO185::Register>),
        // Interrupt Source 186 Priority
        (0x02e8 => pub(crate) prio186: ReadWrite<u32, PRIO186::Register>),
        // Interrupt Source 187 Priority
        (0x02ec => pub(crate) prio187: ReadWrite<u32, PRIO187::Register>),
        // Interrupt Pending
...
register_bitfields![u32,
    ...
    pub(crate) PRIO186 [
        PRIO186 OFFSET(0) NUMBITS(2) [],
    ],
    pub(crate) PRIO187 [
        PRIO187 OFFSET(0) NUMBITS(2) [],
    ],
    pub(crate) IP [
