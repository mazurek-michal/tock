...
pub const I2C0_TRANSCOMPLETE: u32 = 86;
pub const I2C0_TXEMPTY: u32 = 87;
pub const I2C0_TXNONEMPTY: u32 = 88;
pub const I2C0_TXOVERFLOW: u32 = 89;
pub const I2C0_ACQOVERFLOW: u32 = 90;
pub const I2C0_ACKSTOP: u32 = 92;
pub const I2C0_HOSTTIMEOUT: u32 = 92;

pub const I2C1_FMTWATERMARK: u32 = 93;
pub const I2C1_RXWATERMARK: u32 = 94;
pub const I2C1_FMTOVERFLOW: u32 = 95;
pub const I2C1_RXOVERFLOW: u32 = 96;
pub const I2C1_NAK: u32 = 97;
pub const I2C1_SCLINTERFERENCE: u32 = 98;
pub const I2C1_SDAINTERFERENCE: u32 = 99;
pub const I2C1_STRETCHTIMEOUT: u32 = 100;
pub const I2C1_SDAUNSTABLE: u32 = 101;
pub const I2C1_TRANSCOMPLETE: u32 = 102;
pub const I2C1_TXEMPTY: u32 = 103;
pub const I2C1_TXNONEMPTY: u32 = 104;
pub const I2C1_TXOVERFLOW: u32 = 105;
pub const I2C1_ACQOVERFLOW: u32 = 106;
pub const I2C1_ACKSTOP: u32 = 107;
pub const I2C1_HOSTTIMEOUT: u32 = 108;

pub const I2C2_FMTWATERMARK: u32 = 109;
pub const I2C2_RXWATERMARK: u32 = 110;
pub const I2C2_FMTOVERFLOW: u32 = 111;
pub const I2C2_RXOVERFLOW: u32 = 112;
pub const I2C2_NAK: u32 = 113;
pub const I2C2_SCLINTERFERENCE: u32 = 114;
pub const I2C2_SDAINTERFERENCE: u32 = 115;
pub const I2C2_STRETCHTIMEOUT: u32 = 116;
pub const I2C2_SDAUNSTABLE: u32 = 117;
pub const I2C2_TRANSCOMPLETE: u32 = 118;
pub const I2C2_TXEMPTY: u32 = 119;
pub const I2C2_TXNONEMPTY: u32 = 120;
pub const I2C2_TXOVERFLOW: u32 = 121;
pub const I2C2_ACQOVERFLOW: u32 = 122;
pub const I2C2_ACKSTOP: u32 = 123;
pub const I2C2_HOSTTIMEOUT: u32 = 124;

pub const PATTGENDONECH0: u32 = 125;
pub const PATTGENDONECH1: u32 = 126;
...
pub const ADC_CTRL_AON_DEBUG_CABLE: u32 = 157;

pub const AON_TIMER_AON_WKUP_TIMER_EXPIRED: u32 = 158;
pub const AON_TIMER_AON_WDOG_TIMER_BARK: u32 = 159;

pub const SENSOR_CTRL_IO_STATUS_CHANGE: u32 = 160;
pub const SENSOR_CTRL_INIT_STATUS_CHANGE: u32 = 161;

pub const FLASHCTRL_PROGEMPTY: u32 = 162;
pub const FLASHCTRL_PROGLVL: u32 = 163;
pub const FLASHCTRL_RDFULL: u32 = 164;
pub const FLASHCTRL_RDLVL: u32 = 165;
pub const FLASHCTRL_OPDONE: u32 = 166;
pub const FLASHCTRL_CORRERR: u32 = 167;

pub const HMAC_HMACDONE: u32 = 168;
pub const HMAC_FIFOEMPTY: u32 = 169;
pub const HMAC_HMACERR: u32 = 170;

pub const KMAC_KMACDONE: u32 = 171;
pub const KMAC_FIFOEMPTY: u32 = 172;
pub const KMAC_KMACERR: u32 = 173;

pub const OTBN_DONE: u32 = 174;

pub const KEYMGR_OP_DONE: u32 = 175;

pub const CSRNG_CSCMDREQDONE: u32 = 176;
pub const CSRNG_CSENTROPYREQ: u32 = 177;
pub const CSRNG_CSHWINSTEXC: u32 = 178;
pub const CSRNG_CSFATALERR: u32 = 179;

pub const ENTROPY_SRC_ES_ENTROPY_VALID: u32 = 180;
pub const ENTROPY_SRC_ES_HEALTH_TEST_FAILED: u32 = 181;
pub const ENTROPY_SRC_ES_OBSERVE_FIFO_READY: u32 = 182;
pub const ENTROPY_SRC_ES_FATAL_ERR: u32 = 183;

pub const EDN0_EDN_CMD_REQ_DONE: u32 = 184;
